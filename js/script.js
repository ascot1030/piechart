	...
	data :  {
		...
		dataPoints: [
			{label: "Requirements Quality", exploded: true,
				...
				y: {date: "06/30/2017", value: .75, label: "64.0%",  fill: "#69A1C7", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#69A1C7", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .45, label: "45.0%",  fill: "#69A1C7", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#69A1C7", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#69A1C7", text: "#000000", labelPosition: "outside"}
			},
			{label: "Design Quality", exploded: true,
				x: {value: .15, label: "10%",  fill: "#F6CB9D", text: "#F6CB9D", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .50, label: "50.1%",  fill: "#F6CB9D", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#F6CB9D", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#F6CB9D", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#F6CB9D", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#F6CB9D", text: "#000000", labelPosition: "outside"}
			},
			{label: "Code Quality", exploded: true,
				x: {value: .15, label: "10%",  fill: "#AAB3D9", text: "#32508D", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .663, label: "66.3%",  fill: "#32508D", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#32508D", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#32508D", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#32508D", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#32508D", text: "#000000", labelPosition: "outside"}
			},
			{label: "Quality Control", exploded: true,
				x: {value: .10, label: "10%",  fill: "#A291B1", text: "#381755", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .844, label: "84.4%",  fill: "#381755", text: "#000000", labelPosition: "middle"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#381755", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#381755", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#381755", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#381755", text: "#000000", labelPosition: "outside"}
			},
			{label: "Process Improvement", exploded: true,
				x: {value: .15, label: "10%",  fill: "#D9E4AB", text: "#86A724", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .715, label: "71.5%",  fill: "#86A724", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#86A724", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#86A724", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#86A724", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#86A724", text: "#000000", labelPosition: "outside"}
			},
			{label: "Infrastructure", exploded: true,
				x: {value: .05, label: "5%", fill: "#E0A08C", text: "#A2091A", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .852, label: "85.2%", fill: "#A2091A", text: "#000000", labelPosition: "middle"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#A2091A", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#A2091A", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#A2091A", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#A2091A", text: "#000000", labelPosition: "outside"}
			},
			{label: "Domain Knowledge", exploded: true,
				x: {value: .1, label: "10%",  fill: "#969CBF", text: "#0A3369", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .728, label: "72.8%",  fill: "#0A3369", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#0A3369", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#0A3369", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#0A3369", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#0A3369", text: "#000000", labelPosition: "outside"}
			},
			{label: "Resource Management", exploded: true,
				x: {value: .1, label: "10%",  fill: "#FBE7AA", text: "#D2AA16", labelPosition: "outside"}, 
				y: {date: "06/30/2017", value: .585, label: "58.5%",  fill: "#D2AA16", text: "#000000", labelPosition: "outside"},
				a: {date: "03/31/2017", value: .353, label: "35.3%",  fill: "#D2AA16", text: "#000000", labelPosition: "outside"},
				b: {date: "01/01/2017", value: .25, label: "25.0%",  fill: "#D2AA16", text: "#000000", labelPosition: "outside"},
				c: {date: "09/01/2016", value: .25, label: "25.0%",  fill: "#D2AA16", text: "#000000", labelPosition: "outside"},
				d: {date: "06/01/2016", value: .25, label: "25.0%",  fill: "#D2AA16", text: "#000000", labelPosition: "outside"}
			},
		], 
	}, 
	...
	function drawLegend() {
		...
		for (var i = 0; i < dateValues.length; i ++) {
			if (i == 0) {
				...
				html_str += "<label for= y_" + dateValues[i].y.date + " style='font-family: Arial; font-size: 11px; font-weight: bold;'>"+ dateValues[i].y.date +"</label></div>";
				i ++;
			...
			for (key in dateValues[i]) {
				...
				html_str += "<label for=" + key + "_" + date_str[i] + " style='font-family: Arial; font-size: 11px; font-weight: bold;'>"+ date_str[i] +"</label></div>";
			}
